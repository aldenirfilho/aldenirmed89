...
await page.goto(base+'24_Semiologia/index.html');await page.waitForFunction(()=>document.querySelector('#offline-status').textContent.includes('disponíveis offline'),{},{timeout:30000});
